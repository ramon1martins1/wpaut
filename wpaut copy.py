...
#    "Mensagem",
#    value=st.session_state.get(CACHE_KEY_MENSAGEM,
#        "Olá *{nome}*,\n\n*Nova versão do E2 Administrativo 5.31.50/598 liberada!* \n\n Confira a lista de demandas:\n\n* 10536 - Ajuste para processamento de notas fiscais de saída complementar;\n* 15156 - Melhoria na filtragem por pesquisa avançada nos módulos de compras e cobranças.\n\n\nAtenciosamente,\n\nAtendimento E2 Administrativo\n📞 Telefone: (48) 3411-0680"),
#    height=550,
...
# === ENVIO DE MENSAGENS ===
def iniciar_envio():
    # Inicialização (mantenha seu código existente)
    st.session_state.log = []
    st.session_state.resultado_envio = None
    st.session_state.cancelar_envio = False
    st.session_state.ultimo_enviado = None
    ...
    if cancel_button_container.button("❌ Cancelar Envio", key="cancelar_envio_btn"):
    ...
    options.add_argument(r"--user-data-dir=C:\\Ramon\\Estudo\\WpAut\\profile")
